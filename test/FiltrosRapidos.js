...
const FiltrosRapidos = require('../lib/Dashboard/dashboardFpay.js');
...
describe('Suite test Backoffice DashboardFpay', function () {
	...
	it('Búsqueda de Documento por Rut Payments CL', async () => {
	...
	it('Búsqueda de Teléfono Payments CL', async () => {
			// if(data.TipoEjecucion == 'True') {
	...
	it('Búsqueda de Documento por DNI Payments PE', async () => {
		// if(data.TipoEjecucion == 'True') {
	...
	it('Búsqueda de Teléfono Payments PE', async () => {
    	// if(data.TipoEjecucion == 'True') {
